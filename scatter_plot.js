var scatterChart = module.exports = function() {
   ...
   var chart = function(container) {
      var xScale, xAxis, xAxisCssClass, axisLabelMargin, yScale, yAxis, g, points, pointsGroup;
      ...
      function addScatterChartData() {


         points = g.selectAll("g.point").data(data);

         pointsGroup = points.enter().append("g").attr("class", "node")
            .attr('transform', function(d) {
               return "translate(" + (xScale(d.x) + axisLabelMargin) + "," + yScale(d.y) + ")";
            });
      ...
      function addGridLines() {
         ...
         g.selectAll("line.verticalGrid").data(xScale.ticks(xTicks)).enter()
            ...
            .attr({
               ...
               "x1": function(d) {
                  return xScale(d) + axisLabelMargin;
               },
               "x2": function(d) {
                  return xScale(d) + axisLabelMargin;
               },
